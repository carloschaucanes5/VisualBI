...
<html>
    <head>
        ...
        <title>VisualBiTool(Paramatros)</title>
    </head>
    <body>
        <input type="button" class="btn btn-sm dark" value="Cerrar" style="position: absolute;right: 10px;top: 60px" onclick="closeTab(3)"/>
        <%
         ...
         html +="<input type = 'button' value='Descargar' class='btn yellow' onclick='funDataDownload()'/>";
         out.println(html);
        ...
        <div id="divParameters">
            <h4 id='titleRemove'>Distribución de Datos</h4>
            <table>
                <tr><th>Limite Inferior</th><th><input type="text"   value="0" id="idBottom" min="0" max="<%=(numIns-1)%>" /></th></tr>
                <tr><th>Limite Superior</th><th><input type="text" value="<%=(numIns)%>" id="idTop"  min="1" max="<%=(numIns)%>" /></th></tr>
                <tr><th>Atributo1</th><th><%= select1 %></th></tr>
                <tr><th>Atributo2</th><th><%= select2 %></th></tr>
                <tr><th>Atributo3</th><th><%= select3 %></th></tr>
                <tr><th><input type="button" value="Procesar" class="btn yellow" onclick ="funQdProcessLimits1()"></th><td></td></td></tr>
            </table>
        </div>
